        ...
        <form action="<?= base_url('Kodim/cKelolaData/createdata_organisasi') ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group"><label>Nama Organisasi</label><input type="text" name="nama_organisasi" class="form-control" required></div>
                        </div>
                        <div class="col-md-6">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group"><label>Nama Ketua/Pengurus</label><input type="text" name="ketua_organisasi" class="form-control"></div>
                        </div>
                        <div class="col-md-6">
            ...
            <form action="<?= base_url('Kodim/cKelolaData/updatedata_organisasi/' . $value->id_organisasi) ?>" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label>Nama Organisasi</label><input type="text" name="nama_organisasi" value="<?= $value->nama_organisasi ?>" class="form-control" required></div>
                            </div>
                            <div class="col-md-6">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label>Nama Ketua/Pengurus</label><input type="text" name="ketua_organisasi" value="<?= $value->ketua_organisasi ?>" class="form-control"></div>
                            </div>
                            <div class="col-md-6">
