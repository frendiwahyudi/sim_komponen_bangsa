    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="info">
                ...
                Anda Login Sebagai <strong>Kodim</strong>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('Kodim/cDashboard') ?>"
                ...
                <li class="nav-item has-treeview <?= $master_active ? 'menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/kodam') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/korem') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/kodim') ?>"
                ...
                <li class="nav-item has-treeview <?= $kb_active ? 'menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/data_keluarga_besar_tni') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/data_para_tokoh') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/data_organisasi') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Kodim/cKelolaData/organisasi_penggiat_hobi') ?>"
