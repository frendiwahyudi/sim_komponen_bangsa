                ...
                <div class="col-12">
                    ...
                    <div class="tab-content" id="kbtTabContent">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="<?= base_url('Korem/cKelolaData/deletedata_keluarga_besar_tni/' . $value->id_kbt) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        <div class="tab-pane fade" id="tab-korem" role="tabpanel">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Informasi Data Keluarga Besar TNI
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data_keluarga_besar_tni_korem as $value) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <button type="button" data-toggle="modal" data-target="#editkorem<?= $value->id_kbt_korem ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></button>
                                                            <a href="<?= base_url('Korem/cKelolaData/deletedata_keluarga_besar_tni_korem/' . $value->id_kbt_korem) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
...
<div class="modal fade" id="modal-tambah-korem">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('Korem/cKelolaData/createdata_keluarga_besar_tni_korem') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Kelompok KBT</label>
                        <select class="form-control" name="kelompok_kbt" required>
    ...
    <div class="modal fade" id="editkorem<?= $value->id_kbt_korem ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('Korem/cKelolaData/updatedata_keluarga_besar_tni_korem/' . $value->id_kbt_korem) ?>" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Kelompok KBT</label>
                            <select class="form-control" name="kelompok_kbt" required>
