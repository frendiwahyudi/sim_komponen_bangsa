        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header"><h3 class="card-title">Informasi Kodim</h3></div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($kodim as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('Kodam/cKelolaData/deletekodim/' . $value->id_kodim) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <form action="<?= base_url('Kodam/cKelolaData/createkodim') ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="id_korem" class="form-control" required>
...
<?php foreach ($kodim as $key => $value) { ?>
    <div class="modal fade" id="edit<?= $value->id_kodim ?>">
        <div class="modal-dialog">
            <form action="<?= base_url('Kodam/cKelolaData/updatekodim/' . $value->id_kodim) ?>" method="POST">
                <div class="modal-content">
                    <div class="modal-header">
